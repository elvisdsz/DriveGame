...
#include "DriveGameSportsCar.h"
#include "DriveGameSportsWheelFront.h"
#include "DriveGameSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ADriveGameSportsCar::ADriveGameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDriveGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDriveGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDriveGameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDriveGameSportsWheelRear::StaticClass();
